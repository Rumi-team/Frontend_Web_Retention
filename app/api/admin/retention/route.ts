...
export async function GET() {
  ...
  // Try Retention API first (Cloud Run) for rich metrics
  let metrics = await fetchMetrics();

  // Fallback: compute basic metrics directly from Supabase
  // This works even when Cloud Run API is unreachable (no OIDC token, etc.)
